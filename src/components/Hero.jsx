      ...
      <div className="container mx-auto px-4 flex flex-col-reverse lg:flex-row items-center gap-12">
        ...
        <div className="flex-1 space-y-6 text-center lg:text-left">
          <span className="text-sm font-bold text-yellow-500 uppercase tracking-wider">
            ⚡ Learn From 20,000+ Quality Posts
          </span>
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-lg mx-auto lg:mx-0">
            Start Your Education Journey For a Better Future. Access top-tier
          ...
          <div className="relative z-10">
            ...
            <div className="absolute top-1/2 -left-8 bg-white dark:bg-slate-800 p-4 rounded-xl shadow-xl flex items-center gap-4 animate-bounce-slow">
              <div className="flex -space-x-3">
                ...
                <div className="w-10 h-10 rounded-full bg-primary text-white text-xs flex items-center justify-center border-2 border-white font-bold">
                  2K+
                </div>
              </div>
              <div>
